(function () {
  let matrix_one, matrix_three, matrix_six;

  if (window.innerWidth <= 1920) {
    matrix_one = 2.07298;
    matrix_three = 2.07298;
    matrix_six = 198.73;
  }
  ...
  document.addEventListener("scroll", function () {
    try {
      ...
      const videoFrameStatic = document.querySelector(
        ".inline-video-frame-static"
      );
      const overviewHeroTvShadowColor = document.querySelector(
        ".overview-hero-hero-tv-shadow-color"
      );
      const overviewHeroTvRemote = document.querySelector(
